...
export const Projects = () => {
  return (
    <section
      id='projects'
      className='py-20 bg-pink-200/50 backdrop-blur-sm relative overflow-hidden'
    >
      {/* Background */}
      ...
      <div className='max-w-7xl mx-auto py-4 sm:px-6 lg:px-8 relative z-10'>
        ...
        <div className={`grid grid-cols-1 gap-8`}>
          {projectsList.map((project) => {
            return (
              <div
                className={`group relative bg-gradient-to-br rounded-3xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-white/50 overflow-hidden ${project.bgColor}`}
              >
                {/* Background */}
