import { Code, Mail, CircleStar } from 'lucide-react'
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
          <div className='lg:grid lg:grid-cols-2 lg:gap-35 items-center'>
            <div className='mb-12 lg:mb-0'>
              ...
              <div className='flex flex-col-reverse sm:flex-row gap-4 mb-10'>
                ...
                <button className='group border border-white/30 text-white hover:bg-white/40 hover:text-violet-300 px-8 py-4 rounded-2xl font-semibold transition-all duration-200 flex items-center justify-center gap-1 shadow-2xl hover:shadow-violet-900/30 hover:scale-105 '>
                  <Mail
                    sixe={20}
              ...
              <div className='grid grid-cols-3 gap-6'>
                <div className='text-center'>
                  <div className='text-3xl font-bold text-white mb-1'>NN</div>
