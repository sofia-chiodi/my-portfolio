              ...
              >
                <div className='relative overflow-hidden'>
                  ...
                  <div className='absolute inset-0 bg-gradient-to-t from-black/50 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-200'>
                    <div className='absolute items-end bottom-4 right-4'>
                      ...
                      <button className='w-10 h-10 bg-violet-300/30 backdrop-blur-sm rounded-full flex items-center justify-center hover:scale-110 transition-all duration-300'>
                        <a
                          href={project.githubUrl}
                          target='_blank'
                          rel='noopener noreferrer'
